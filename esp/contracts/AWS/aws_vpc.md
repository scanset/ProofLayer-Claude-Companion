...
**Collection Method:** Up to three AWS CLI commands per object via the AWS CLI

**Note:** This contract uses `exists` instead of `found` for its existence field, and does not produce a `resource` RecordData field.
